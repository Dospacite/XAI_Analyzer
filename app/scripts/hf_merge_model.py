...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Merge a PEFT adapter and upload a standalone model.")
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="merged-model-") as output_dir:
